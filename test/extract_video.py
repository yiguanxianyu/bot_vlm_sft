...
filename = r"C:\Users\yigua\Downloads\Bon Iver - Everything Is Peaceful Love (Official Video)-1.mp4"
...
with av.open(filename) as container:
    ...
    print(f"Resolution: {video_stream.codec_context.width}x{video_stream.codec_context.height}")
